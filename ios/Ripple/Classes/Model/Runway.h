...
typedef enum{
	RunwayWatchedState = 1,
	RunwayNeutralState = 0,
	RunwayClearState = -1
} RunwayState;
...
@property(nonatomic, assign) RunwayState state;
@property(assign) int heading1;
@property(assign) int heading2;
@property(assign) BOOL stateHasChanged;
