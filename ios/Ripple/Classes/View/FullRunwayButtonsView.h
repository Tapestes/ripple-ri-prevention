...
@protocol AircraftCommandDelegate <NSObject>
...
@interface FullRunwayButtonsView : UIView {
    
    IBOutlet UILabel* titleLabel;
    id<AircraftCommandDelegate> delegate;
}

@property (retain) UILabel* titleLabel;
@property (retain) id<AircraftCommandDelegate> delegate;
