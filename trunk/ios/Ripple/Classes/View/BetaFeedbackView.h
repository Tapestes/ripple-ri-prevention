...
@interface BetaFeedbackView : UIView {
	UIButton* earlyAlertButton;
	UIButton* goodAlertButton;
	UIButton* lateAlertButton;
	UIButton* falseAlertButton;
	
	AlertRecord* alert;
}

@property (retain) AlertRecord* alert;
